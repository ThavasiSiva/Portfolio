      ...
      <Container className="container mb-4">
        ...
        <Row className="d-flex justify-content-around project-row">
          <Col
            md={4}
            xs={12}
            className="d-flex flex-column align-items-center mt-4 pt-3 mt-md-5 pt-md-2 project"
          >
            <Image
              src={calander}
              rounded
            ...
            <div className="text-center mt-2">
              <a
                href="https://ageanalyzer.netlify.app"
          ...
          >
            ...
            <div className="text-center mt-2">
              <a
                href="https://mathevaluator.netlify.app"
                className="project_link"
                target="_blank"
                rel="noopener noreferrer"
              >
          ...
          >
            ...
            <div className="text-center mt-2">
              <a
                href="https://todosheet.netlify.app"
                className="project_link"
                target="_blank"
                rel="noopener noreferrer"
              >
